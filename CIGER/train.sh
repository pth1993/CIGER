...
--drug_id_file "data/drug_id.csv" --gene_file "data/gene_go_vector.csv" \
--data_file "data/signature.csv" --fp_type 'neural' --label_type 'raw' --loss_type 'list_wise_rankcosine' \
